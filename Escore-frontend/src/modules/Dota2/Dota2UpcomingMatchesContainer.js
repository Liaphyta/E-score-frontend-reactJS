...
import { getUpcomingMatches } from './Dota2Repo';
import './Dota2containers.css';
import { Card } from '@material-ui/core';

export default class Dota2UpcomingMatchesContainer extends React.Component
{
    constructor(props) {
        super(props)
        this.state ={
          ...
          return(
            ...
            <Card style={{float:'right',textAlign:'center',marginTop:'200px',paddingTop:'5px',background: 'rgba(255,193,7, 0.8)'}}>
              ...
              <div style={{float:'left',marginTop:'50px',marginLeft:'20px'}}>
                  <Link to="/dota2/previous"><Button variant="warning" style={{float:'left',marginRight:'40px'}}>View Finished Matches</Button></Link>
