...
import { getUpcomingMatches } from './LeagueOfLegendsRepo';
...
export default class LolUpcomingMatchesContainer extends React.Component{
    constructor(props) {
        super(props)
        this.state ={
          formdata: {},
          ...
          return(
            ...
            <Link to="/lol/leagues/network" style={{float:'left',paddingTop:'15%',paddingLeft:'20%'}}><Button variant="warning" style={{height:'60px',width:'100%'}}>Explore the network of matches</Button></Link>
              ...
              <div style={{float:'left',marginTop:'50px',marginLeft:'20px'}}>
                  <Link to="/lol/previous"><Button  variant="warning" style={{float:'left',marginRight:'40px'}}>View Finished Matches</Button></Link>
