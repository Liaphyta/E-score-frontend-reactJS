...
import { getPreviousMatches } from './CsgoRepo';
import './CsgoContainers.css';
import { Card } from '@material-ui/core';
export default class CsgoPreviousMatchesContainer extends React.Component
{
    constructor(props) {
        super(props)
        this.state ={
          ...
          return(
            ...
            Windows, OS X, Xbox 360, and PlayStation 3 on August 21, 2012, while the Linux version was released in 2014.
              ...
              <div style={{float:'left',marginTop:'50px',marginLeft:'20px'}}>
                  <Link to="/csgo/upcoming"><Button variant="warning" style={{float:'left',marginRight:'40px'}}>View Upcoming Matches</Button></Link>
